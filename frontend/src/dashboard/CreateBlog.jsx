...
function CreateBlog() {
  ...
  return (
    <div>
      <div className=" p-6">
        <div className="max-w-2xl mx-auto p-6 border md:mt-1  mt-6 rounded-lg shadow-lg bg-blue-300">
        <img src="logo.png" alt="" className="w-[60px] my-3" />
